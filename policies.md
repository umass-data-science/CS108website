...
The coursework will consist of weekly homework assignments, weekly labs, a midterm exam and a final exam. The lowest two homework grades and the lowest two lab grades will be dropped from your homework and lab totals. You will be allowed to drop ONE homework score (per updated policy 2/24/2020).  The grading scheme is shown below:
